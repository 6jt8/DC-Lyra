const lang: Record<string, any> = {
    ...
    ping: {
        ...
        header: {
            title: "# Bot-Latenz",
            botName: "**{botName}** - Lyra Musik-Bot",
    ...
    events: {
        interactionCreate: {
            ...
            rateLimited: "⏳ **Das geht dir zu schnell!**\nBitte warte **{seconds}** Sekunde(n), bevor du einen weiteren Befehl verwendest.",
    ...
    console: {
        bot: {
            ...
            databaseOnline: "Datenbank Online ✅",
        ...
        database: {
            uriNotDefined: "Datenbank-URI ist in der Konfiguration nicht definiert.",
            skippingConnection: "Überspringe Datenbankverbindung, da keine URI bereitgestellt wurde.",
            connected: "Verbunden mit Datenbank ✅",
            connectionFailed: "Verbindung zur Datenbank fehlgeschlagen. Fortfahren ohne Datenbankfunktionalität."
        },
        lavalink: {
