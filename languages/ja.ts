const lang: Record<string, any> = {
    ...
    events: {
        interactionCreate: {
            ...
            rateLimited: "⏳ **操作が早すぎます！**\n次のコマンドを使用するまで **{seconds}** 秒お待ちください。",
    ...
    console: {
        ...
        database: {
            uriNotDefined: "データベースURIが設定で定義されていません。",
            skippingConnection: "URIが提供されていないため、データベースへの接続をスキップします。",
            connected: "データベースに接続されました ✅",
            connectionFailed: "データベースへの接続に失敗しました。データベース機能なしで続行します。"
        },
        lavalink: {
