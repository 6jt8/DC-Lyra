const lang: Record<string, any> = {
    ...
    console: {
        ...
        database: {
            uriNotDefined: "구성에서 데이터베이스 URI가 정의되지 않았습니다.",
            skippingConnection: "URI가 제공되지 않아 데이터베이스 연결을 건너뜁니다.",
            connected: "데이터베이스에 연결됨 ✅",
            connectionFailed: "데이터베이스에 연결할 수 없습니다. 데이터베이스 기능 없이 계속합니다."
        },
        lavalink: {
